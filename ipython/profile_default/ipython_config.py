...
c.InteractiveShellApp.exec_lines = [
    "%run ~/.config/ipython/profile_default/startup/00-status-prompt.py"
]
...
#  Default: "Python 3.13.13 (main, May  4 2026, 21:02:24) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.13.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.13.13 (main, May  4 2026, 21:02:24) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.13.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.13.13 (main, May  4 2026, 21:02:24) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.13.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#  Known usage are: IPython's own testing machinery, and emacs' inferior-python
#  subprocess (assuming you have set `python-shell-interpreter` to "ipython")
#  available through the built-in `M-x run-python` and third party packages such
#  as elpy.
#  
#  This mode default to `True` if the `IPY_TEST_SIMPLE_PROMPT` environment
#  variable is set, or the current terminal is not a tty. Thus the Default value
#  reported in --help-all, or config will often be incorrectly reported.
#  Default: False
...
#  
#  Successive options allow to enable more eager evaluation for better completion
#  suggestions, including for nested dictionaries, nested lists, or even results
#  of function calls. Setting ``unsafe`` or higher can lead to evaluation of
#  arbitrary user code on :kbd:`Tab` with potentially unwanted or dangerous side
#  effects.
#  
#  Allowed values are:
#  
...
#  
#  To override specific elements of the policy, you can use ``policy_overrides``
#  trait.
...
#  
#  - ``Completer.evaluation = 'unsafe'`` - ``Completer.auto_close_dict_keys =
#  True``
#  Default: False
